...
import RedCarModel from "../components/RedCarModel.tsx";
...
const About = () => {
  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="absolute top-[60%] sm:top-[33%] left-[15%] h-36 w-36 bg-blue-700 "></div>
      <div className="relative backdrop-blur-[100px]">
        ...
        <div className="relative h-[20rem] w-screen sm:w-[80rem] sm:m-4">
          <RedCarModel/>
        </div>
      </div>
    </div>
